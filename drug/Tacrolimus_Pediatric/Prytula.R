...
des_intro <-  c("Tacrolimus po model for pediatric kidney transplant recipients, at least 1 year after renal transplantation.", 
                "<br>", 
                "Data were obtained from 54 patients, age ranging from 3.8 to 18.4 years", 
                "<br>",
...
des_notes <- c("- measurement time is recommended to be matched with the first dose",
               "<br>",
               "- Detailed tracking of CYP3A5, WT, rGT and HCT is recommend to reflect physiological changes in clearance and volume of distribution")
...
mod_cov_abbr <- c("*1 indicates wild type, and *3 indicates polymorphism", "Patient's weight(kg)", "r-glutamyl transpeptidase(U/L)", "Hematocrit")
...
pk_color <- '#FF6666'
  ...
  sd_eta <- sqrt(c(0.2899, 0.1844, 1.3584)) # put sd^2 value in this vector
